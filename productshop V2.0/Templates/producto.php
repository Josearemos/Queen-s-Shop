        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    ...
                    <div class="col">
                        <button type="submit" class="btn btn-warning form-control">Añadir al Carrito</button>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>Ahora:</td>
                        <td class="font-size-20 text-danger"><span><?php echo isset($item['item_price']) ? $item['item_price'] : 0; ?>€</span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Final:</td>
                        <<td class="font-size-20 text-danger"><span><?php echo isset($item['item_price']) ? $item['item_price'] : 0; ?>€</span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Vendedor y Distribuidor: <a href="#">Queen's Shop</a></small>
